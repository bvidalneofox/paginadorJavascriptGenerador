...
function buscarImagenes() {
    ...
    const key = '19334814-bc9b05d1ed3cf2e0cc1a1d765';
    const url = `https://pixabay.com/api/?key=${key}&q=${termino}&image_type=photo&per_page=${registroPorPagina}&page=${paginaActual}`;
